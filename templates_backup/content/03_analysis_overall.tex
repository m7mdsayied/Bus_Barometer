...
\begin{minipage}{0.85\textwidth}
    ...
    \vspace{0.8em}
    \label{sec:bbi}
    {\fontsize{10}{13}\selectfont \textbf{\ECESContent{overall_intro}{The business performance index continued to surpass the neutral level during the quarter under study, with varying performance across sectors.}}}
...
\ECESContent{overall_footnotes_pg12}{\textit{Source:} Survey results.\\
...
% ---------------------------------------------------------
\noindent
{\fontsize{10}{13}\selectfont \textbf{\ECESContent{overall_sector_perf_intro}{The following is an analysis of performance of the economic sectors during the quarter under study, based on the sample’s responses, and compared to the previous and corresponding quarters:}}}
...
% ---------------------------------------------------------
\noindent
{\fontsize{10}{13}\selectfont \textbf{\ECESContent{overall_sector_exp_intro}{On the outlook side, the expectations index exceeded the neutral level for all sectors, with the telecommunications sector reporting the best values:}}}

\begin{itemize} \itemsep0.6em
    \item \fontsize{10}{13}\selectfont \ECESContent{overall_exp_manufacturing}{The outlook index for the manufacturing sector exceeded the neutral level by 4 points, with values higher than the previous and corresponding quarters. This is due to expectations that all sub-indices will remain stable during the upcoming quarter.}
\end{itemize}
